...
def build_linkedlistbag(sorted_dataset : dict):
    ...
    for fork_id in sorted_dataset.keys(): # TEAM..., 
        ...
        for emp_x, emp_y, in_dt in sorted_dataset[fork_id] : # ['172978.787361283','252229.400114715','2019-06-01 08:30:48.797'] ['172978.787361283','252229.400114715','2019-06-01 08:30:48.797']
            emp_x  = float(emp_x)
            emp_y  = float(emp_y)
    ...
    # linkedlist_bag_dict = defaultdict(LinkedListBag)
    # linkedlist_bag_dict = defaultdict(lambda : LinkedListBag())

    # for fork_id, data in sorted_dataset.items(): # TEAM..., 
    #     # linkedlist_bag_dict[fork_id] = LinkedListBag()
    #     for emp_x, emp_y, in_dt in data: 
    #         emp_x  = float(emp_x)
    #         emp_y  = float(emp_y)
    #         in_dt  = datetime.strptime(in_dt, "%Y-%m-%d %H:%M:%S.%f")
    #         linkedlist_bag_dict[fork_id].append(ForkliftNode(fork_id, emp_x, emp_y, in_dt))
